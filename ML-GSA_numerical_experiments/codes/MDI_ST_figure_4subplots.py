...
for plot_index, plot_item in enumerate(plot_list):
    ...
    # plt.xlim([-0.05, 1.05])
    # plt.ylim([-0.05, 1.05])
# axes[3].legend(bbox_to_anchor=(1.01, 1), ncol=5)
# legend = axes[3].legend(loc=0)
...
axes[2].set_xlabel('MDI XGB')
axes[3].set_xlabel('MDI RF')
# plt.tight_layout()
fig.subplots_adjust(bottom=0.2)
plt.savefig('final_figures/good_quality/new_MDI_' + funct_name + '_' + error_type + '4_subplots.png', dpi=500)
